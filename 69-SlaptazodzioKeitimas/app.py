...
class Vartotojas(db.Model, UserMixin):
    ...
    el_pastas = db.Column("El.Pastas", db.String(120),
                          unique=True, nullable=False)
    nuotrauka = db.Column("Nuotrauka", db.String(
        20), nullable=False, default="default.jpg")
    slaptazodis = db.Column("Slaptazodis", db.String(60),
                            unique=True, nullable=False)
...
app.config['MAIL_USERNAME'] = "codetest250@gmail.com"
app.config['MAIL_PASSWORD'] = "pakeistas_slaptazodis"
