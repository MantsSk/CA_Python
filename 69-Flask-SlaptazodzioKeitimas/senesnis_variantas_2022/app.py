...
from secret_things import password
...
app.config['MAIL_USERNAME'] = "anotheryetanother603@gmail.com"
app.config['MAIL_PASSWORD'] = "momqxeerfyoduqmn"
...
def send_reset_email(user):
    ...
    msg = Message("Slaptazodzio atnaujinimo uzklausa", sender="anotheryetanother603@gmail.com", recipients=[user.el_pastas])
